...
export function Footer() {
  ...
  return (
    <footer className="border-t border-gray-200 dark:border-gray-800 bg-white/80 dark:bg-dark-bg/80 backdrop-blur-xl">
      <div className="max-w-6xl mx-auto px-3 sm:px-4 py-0 sm:py-4">
